...
import worker from "/Users/hkbertoson/Dev/sleepy-spiral/.wrangler/tmp/bundle-y6t8sX/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/Users/hkbertoson/Dev/sleepy-spiral/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/Users/hkbertoson/Dev/sleepy-spiral/.wrangler/tmp/bundle-y6t8sX/middleware-insertion-facade.js";
